...
// เช็ค session และ role (ผู้บริหาร หรือ เจ้าหน้าที่)
if (!isset($_SESSION['username']) || !isset($_SESSION['role']) || !in_array($_SESSION['role'], ['ผู้บริหาร', 'director', 'DIR', 'เจ้าหน้าที่'])) {
...
try {
    ...
    $sql = "SELECT rb.*, t.Teach_name as teacher_name, t.Teach_phone as teacher_phone,
    ...
    echo json_encode(['success' => false, 'list' => [], 'error' => $e->getMessage()]);
}
