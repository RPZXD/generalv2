    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center">
                <!-- Mobile Menu Button -->
                <button onclick="toggleSidebar()" class="lg:hidden p-2 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors">
                ...
                <div class="ml-4 lg:ml-0">
                    <h1 class="text-lg font-semibold text-gray-800 dark:text-white hidden sm:block">
                        <?php echo $pageTitle ?? 'Admin Control Panel'; ?>
                    </h1>
                </div>
            </div>
            ...
            <div class="flex items-center space-x-4">
                ...
                <!-- User Info -->
                <div class="hidden md:flex items-center space-x-2 px-3 py-1.5 bg-gradient-to-r from-indigo-100 to-blue-100 dark:from-indigo-900/30 dark:to-blue-900/30 rounded-lg">
                    <i class="fas fa-user-shield text-indigo-600 dark:text-indigo-400"></i>
                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300"><?php echo htmlspecialchars($fullname ?? $username ?? 'ผู้ดูแลระบบ'); ?></span>
                    <span class="px-2 py-0.5 text-xs bg-indigo-500 text-white rounded-full"><?php echo htmlspecialchars($role ?? 'admin'); ?></span>
                </div>
                
                <!-- Dark Mode Toggle -->
                <button onclick="toggleDarkMode()" class="relative w-14 h-7 bg-gray-200 dark:bg-gray-700 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 group">
                ...
                <div class="relative">
                    <div class="flex items-center space-x-2 p-1 rounded-lg">
                        <div class="w-9 h-9 rounded-full bg-gradient-to-br from-indigo-500 to-blue-600 flex items-center justify-center text-white font-bold text-lg shadow-lg">
                            🛠️
                        </div>
                    </div>
                </div>
