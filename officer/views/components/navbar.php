<!-- Top Navbar for Officer - Refined & Modern -->
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="hidden md:flex items-center space-x-3 px-4 py-2 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800/50">
                    <i class="fas fa-clock text-indigo-500 animate-pulse-slow"></i>
                ...
                <div class="flex items-center gap-3 pl-3 border-l border-slate-200 dark:border-slate-800">
                    <div class="hidden sm:flex flex-col items-end">
                        ...
                        <span class="text-[9px] font-black text-indigo-500 uppercase tracking-widest">Officer Role</span>
                    </div>
                    
                    <!-- Avatar with Role Badge -->
                    <div class="relative">
                        <div class="w-10 h-10 rounded-2xl bg-gradient-to-br from-indigo-500 to-fuchsia-600 flex items-center justify-center text-white shadow-lg shadow-indigo-500/20 text-xl overflow-hidden border-2 border-white dark:border-slate-700">
                ...
                <!-- Dark Mode Toggle -->
                <button onclick="toggleDarkMode()" class="w-10 h-10 flex items-center justify-center bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-xl hover:bg-indigo-50 dark:hover:bg-indigo-900/30 hover:text-indigo-600 dark:hover:text-indigo-400 transition-all">
