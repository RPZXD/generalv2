...
<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full lg:translate-x-0">
    <!-- Sidebar Background -->
    <div class="h-full overflow-y-auto bg-gradient-to-b from-fuchsia-800 via-purple-900 to-slate-950 dark:from-slate-900 dark:via-slate-950 dark:to-black">
        
        <!-- Logo Section -->
        <div class="px-6 py-5 border-b border-white/10">
            <a href="index.php" class="flex items-center space-x-3 group">
                <div class="relative">
                    <div class="absolute inset-0 bg-gradient-to-r from-fuchsia-500 to-pink-600 rounded-full blur-lg opacity-50 group-hover:opacity-75 transition-opacity"></div>
                    <img src="../dist/img/<?php echo $global['logoLink'] ?? 'logo-phicha.png'; ?>" class="relative w-12 h-12 rounded-full ring-2 ring-white/20 group-hover:ring-fuchsia-400 transition-all" alt="Logo">
                </div>
                <div>
