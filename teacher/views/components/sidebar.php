        ...
        <div class="px-5 py-5 border-b border-white/10 h-20 flex items-center overflow-hidden">
            <a href="index.php" class="flex items-center space-x-4 group/logo shrink-0">
                <div class="relative shrink-0">
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl blur-lg opacity-50 group-hover/logo:opacity-75 transition-opacity">
                    </div>
                    <img src="../dist/img/<?php echo $global['logoLink'] ?? 'logo-phicha.png'; ?>"
                        class="relative w-10 h-10 rounded-xl ring-2 ring-white/10 group-hover/logo:ring-blue-400 transition-all object-cover"
                        alt="Logo">
                </div>
                <div class="sidebar-text opacity-100 transition-opacity duration-300 whitespace-nowrap">
                    ...
                    <p class="text-[10px] font-bold text-blue-400 uppercase tracking-widest">Teacher Hub</p>
                </div>
            </a>
        </div>
