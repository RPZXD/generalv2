    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center space-x-4">
                ...
                <!-- User Info -->
                <div class="hidden md:flex items-center space-x-2 px-3 py-1.5 bg-gradient-to-r from-emerald-100 to-teal-100 dark:from-emerald-900/30 dark:to-teal-900/30 rounded-lg">
                    <i class="fas fa-steering-wheel text-emerald-600 dark:text-emerald-400"></i>
                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300"><?php echo htmlspecialchars($fullname ?? $username ?? 'คนขับรถ'); ?></span>
                    <span class="px-2 py-0.5 text-xs bg-emerald-500 text-white rounded-full"><?php echo htmlspecialchars($role ?? 'คนขับรถ'); ?></span>
                </div>
                ...
                <div class="relative">
                    <div class="flex items-center space-x-2 p-1 rounded-lg">
                        <div class="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white font-bold text-sm shadow-lg">
                            <?php echo strtoupper(mb_substr($fullname ?? $username ?? 'D', 0, 1, "UTF-8")); ?>
                        </div>
                    </div>
                </div>
            </div>
