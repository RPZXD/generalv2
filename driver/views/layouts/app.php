...
$role = $role ?? $_SESSION['role'] ?? 'คนขับรถ';
?>
<!DOCTYPE html>
...
<body class="font-mali bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 min-h-screen transition-colors duration-500">
    ...
    <script>
        const currentUserFullname = '<?php echo $fullname; ?>';
